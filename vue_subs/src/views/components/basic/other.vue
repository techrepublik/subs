            ...
            <BCol sm="12">
                <BCard no-body>
                    <BCardHeader>
                        ...
                        <p class="mb-0">Change the way in which the content is selected when the user interacts with it.
                        </p>
                    </BCardHeader>
                    <BCardBody>
                        <BRow>
                            <label class="col-lg-2 col-sm-12 text-lg-end"><b>User select all</b></label>
                            <BCol lg="6" md="10" sm="12">
                        ...
                        <BRow>
                            ...
                            <BCol lg="6" md="10" sm="12">
                                <p class="user-select-none">This paragraph will not be selectable when clicked by the user.
                                </p>
                            </BCol>
                        </BRow>
                    </BCardBody>
                ...
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <BRow>
                            ...
                            <BCol lg="6" md="10" sm="12">
                                <p class="lh-sm">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                                    Donec sed
                                    odio dui. Cras mattis pannenkoek purus sit
                                    amet fermentum.</p>
                            </BCol>
                        ...
                        <BRow>
                            ...
                            <BCol lg="6" md="10" sm="12">
                                <p class="lh-base">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                                    Donec
                        ...
                        <BRow>
                            ...
                            <BCol lg="6" md="10" sm="12">
                                <p class="lh-lg">Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
                                    Donec sed
                                    odio dui. Cras mattis pannenkoek purus sit
                                    amet fermentum.</p>
                            </BCol>
            ...
            <BCol sm="12">
                <BCard no-body>
                    <BCardHeader>
                        ...
                        <p class="mb-0">Bootstrap provides <code>pe-none</code> and <code>pe-auto</code> classes to prevent
                            or
                        ...
                        <BRow>
                            ...
                            <BCol lg="6" md="10" sm="12">
                                <p class="pe-none"><a href="#">This link</a> can not be clicked because the
                                    ...
                                    However, <a href="#" class="pe-auto">this link</a> has a <code>pe-auto</code> class and
                                    can be
                                    clicked.
                                </p>
                            </BCol>
                    ...
                    <BCardBody>
                        <BRow class="g-4">
                            ...
                            <BCol sm="12">
                                ...
                                <span
                                    class="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-right"
                                    data-bs-toggle="tooltip" title="rounded-right"></span>
                                <span
                                    class="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-bottom"
                                ...
                                <span
                                    class="hei-75 wid-75 bg-body d-inline-block me-2 border border-secondary rounded-circle"
                                    data-bs-toggle="tooltip" title="rounded-circle"></span>
                                <span
                                    class="hei-75 wid-120 bg-body d-inline-block me-2 border border-secondary rounded-pill"
                    ...
                    <BCardBody>
                        <BRow class="g-4">
                            <BCol md="6">
                                ...
                                <hr class="my-2">
                                <label data-bs-toggle="tooltip" class="badge bg-light-secondary p-1 mx-1"
