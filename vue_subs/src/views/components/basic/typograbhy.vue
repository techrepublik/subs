    ...
    <Layout>
        <BRow>
            <BCol md="10" xxl="9" class="mb-4">
                <h2>Typography</h2>
                <p class="text-muted">Documentation and examples for Bootstrap typography, including global settings,
        ...
        <BRow>
            <BCol sm="12">
                <BCard no-body>
                    <BCardHeader>
                        <h5>Headings</h5>
                        <p><span class="badges">.h1</span> through .h6 classes are also available, for when you want to
                            match
