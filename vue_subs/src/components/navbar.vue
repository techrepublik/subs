...
<template>
    <div class="header-wrapper"> <!-- [Mobile Media Block] start -->
            ...
            <ul class="list-unstyled">
                ...
                <li class="pc-h-item d-none d-md-inline-flex">
                    <form class="form-search">
                        ...
                        <input type="search" ref="searchInput" class="form-control" placeholder="Search. . ." id="serchFildid">
        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                <BDropdown variant="transparent" class="pc-h-item d-none d-md-inline-flex" toggle-class="text-reset pc-head-link dropdown-btn arrow-none dropdown p-0" menu-class="dropdown-menu-end dropdown-qta p-0 mt-3" aria-haspopup="true">
                ...
                <BDropdown variant="transparent" class="pc-h-item" toggle-class="text-reset dropdown-btn pc-head-link arrow-none p-0" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -150, crossAxis: 0, mainAxis: 20 }">
                ...
                <rightBar />
                <BDropdown variant="transparent" auto-close="outside" class="pc-h-item card-header-dropdown pb-0" toggle-class="text-reset dropdown-btn pc-head-link arrow-none p-0" menu-class="dropdown-menu-end" aria-haspopup="true" :offset="{ alignmentAxis: -140, crossAxis: 0, mainAxis: 20 }">
                ...
                <BDropdown v-model="show" variant="transparent" auto-close="outside" class="pc-h-item card-header-dropdown pb-0" toggle-class="text-reset dropdown-btn pc-head-link arrow-none p-0 me-0" menu-class="dropdown-menu-end dropdown-notification pc-h-dropdown" aria-haspopup="true" :offset="{ alignmentAxis: -145, crossAxis: 0, mainAxis: 20 }">
                    ...
                    <div>
                        <simplebar class="dropdown-body text-wrap header-notification-scroll position-relative" style="max-height: calc(100vh - 235px)">
                ...
                <BDropdown variant="transparent" auto-close="outside" class="pc-h-item header-user-profile card-header-dropdown py-0" toggle-class="text-reset dropdown-btn pc-head-link arrow-none me-0" menu-class="dropdown-menu-end dropdown-user-profile dropdown-menu-end pc-h-dropdown" aria-haspopup="true" :offset="{ alignmentAxis: -145, crossAxis: 0, mainAxis: 20 }">
                    ...
                    <div class="dropdown-body">
                        <simplebar data-simplebar class="profile-notification-scroll position-relative" style="max-height: calc(100vh - 235px)">
                                ...
                                <li class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 mx-3">
                                            ...
                                            <a class="link-primary" href="mailto:carson.darrin@company.io">{{email}}</a>
                                        </div>
